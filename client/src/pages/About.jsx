  ...
  return (
    <div className="px-4 py-12 max-w-3xl mx-auto">
      ...
      <p className="mb-4 text-slate-700">
        Это среднее (MongoDB, Express, React, Node.js) стековое приложение с идентификация. Он позволяет пользователям
        регистрироваться, входить в систему и выходить из системы, а также предоставляет доступ к защищенным маршрутам
        только для прошедших проверку подлинности пользователей.
      </p>
      <p className="mb-4 text-slate-700">
      ...
      <p className="mb-4 text-slate-700">
        ...
        аутентификацией с использованием стека MEAN. Не стесняйтесь использовать его в качестве шаблона для своих
