  ...
  return (
    <div className="max-w-3xl mx-auto p-3">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        <input className="bg-slate-100 p-3 rounded-lg" type="text" placeholder="Никнейм" id="username" onChange={handlerChange} />
        ...
        <button type="submit" disabled={loading} className="bg-slate-700 p-3 rounded-lg text-white uppercase disabled:opacity-80 hover:opacity-95">{loading ? "Загрузка..." : "Зарегистрироваться"}</button>
        <OAuth />
      </form>
